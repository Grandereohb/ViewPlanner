...
if("FALSE" STREQUAL "TRUE")
  set(simple_message_SOURCE_PREFIX /home/ros/abb_ws/src/industrial_core/simple_message)
  set(simple_message_DEVEL_PREFIX /home/ros/abb_ws/devel)
  ...
  set(simple_message_INSTALL_PREFIX /home/ros/abb_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simple_message' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT simple_message_NUM_DUMMY_TARGETS)
      set(simple_message_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::simple_message::wrapped-linker-option${simple_message_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR simple_message_NUM_DUMMY_TARGETS "${simple_message_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::simple_message::wrapped-linker-option${simple_message_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND simple_message_LIBRARIES "${interface_target_name}")
