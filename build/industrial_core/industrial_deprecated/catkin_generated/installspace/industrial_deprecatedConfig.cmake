...
if("FALSE" STREQUAL "TRUE")
  set(industrial_deprecated_SOURCE_PREFIX /home/ros/abb_ws/src/industrial_core/industrial_deprecated)
  set(industrial_deprecated_DEVEL_PREFIX /home/ros/abb_ws/devel)
  ...
  set(industrial_deprecated_INSTALL_PREFIX /home/ros/abb_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/industrial_deprecated " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/industrial_deprecated' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'industrial_deprecated' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'industrial_deprecated' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT industrial_deprecated_NUM_DUMMY_TARGETS)
      set(industrial_deprecated_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::industrial_deprecated::wrapped-linker-option${industrial_deprecated_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR industrial_deprecated_NUM_DUMMY_TARGETS "${industrial_deprecated_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::industrial_deprecated::wrapped-linker-option${industrial_deprecated_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND industrial_deprecated_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${industrial_deprecated_dep}_FOUND)
      find_package(${industrial_deprecated_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${industrial_deprecated_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
