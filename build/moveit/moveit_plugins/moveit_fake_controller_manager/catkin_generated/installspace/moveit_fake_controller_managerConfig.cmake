...
if("FALSE" STREQUAL "TRUE")
  set(moveit_fake_controller_manager_SOURCE_PREFIX /home/ros/abb_ws/src/moveit/moveit_plugins/moveit_fake_controller_manager)
  set(moveit_fake_controller_manager_DEVEL_PREFIX /home/ros/abb_ws/devel)
  ...
  set(moveit_fake_controller_manager_INSTALL_PREFIX /home/ros/abb_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://moveit.ros.org " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Michael Görner <me@v4hn.de>, MoveIt Release Team <moveit_releasers@googlegroups.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'moveit_fake_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'moveit_fake_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT moveit_fake_controller_manager_NUM_DUMMY_TARGETS)
      set(moveit_fake_controller_manager_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::moveit_fake_controller_manager::wrapped-linker-option${moveit_fake_controller_manager_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR moveit_fake_controller_manager_NUM_DUMMY_TARGETS "${moveit_fake_controller_manager_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::moveit_fake_controller_manager::wrapped-linker-option${moveit_fake_controller_manager_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND moveit_fake_controller_manager_LIBRARIES "${interface_target_name}")
...
set(depends "moveit_core;moveit_ros_planning;roscpp")
