...
if("FALSE" STREQUAL "TRUE")
  set(moveit_core_SOURCE_PREFIX /home/ros/abb_ws/src/moveit/moveit_core)
  set(moveit_core_DEVEL_PREFIX /home/ros/abb_ws/devel)
  ...
  set(moveit_core_INSTALL_PREFIX /home/ros/abb_ws/install)
...
if(NOT "include;/usr/include;/usr/include/eigen3;/opt/ros/noetic/include;/usr/include/bullet " STREQUAL " ")
  set(moveit_core_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include;/usr/include/eigen3;/opt/ros/noetic/include;/usr/include/bullet")
  ...
  elseif(NOT "http://moveit.ros.org " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Dave Coleman <dave@picknik.ai>, Michael Görner <me@v4hn.de>, Michael Ferguson <mferguson@fetchrobotics.com>, MoveIt Release Team <moveit_releasers@googlegroups.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
    _list_append_unique(moveit_core_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "moveit_exceptions;moveit_background_processing;moveit_kinematics_base;moveit_robot_model;moveit_transforms;moveit_robot_state;moveit_robot_trajectory;moveit_planning_interface;moveit_collision_detection;moveit_collision_detection_fcl;moveit_collision_detection_bullet;moveit_kinematic_constraints;moveit_planning_scene;moveit_constraint_samplers;moveit_planning_request_adapter;moveit_profiler;moveit_python_tools;moveit_trajectory_processing;moveit_distance_field;moveit_collision_distance_field;moveit_kinematics_metrics;moveit_dynamics_solver;moveit_utils;moveit_test_utils;/usr/lib/x86_64-linux-gnu/libboost_system.so.1.71.0;/usr/lib/x86_64-linux-gnu/libboost_filesystem.so.1.71.0;/usr/lib/x86_64-linux-gnu/libboost_date_time.so.1.71.0;/usr/lib/x86_64-linux-gnu/libboost_thread.so.1.71.0;/usr/lib/x86_64-linux-gnu/libboost_iostreams.so.1.71.0;/usr/lib/x86_64-linux-gnu/libboost_regex.so.1.71.0;/opt/ros/noetic/lib/x86_64-linux-gnu/libfcl.so.0.6.1;/usr/lib/x86_64-linux-gnu/libccd.so;/usr/lib/x86_64-linux-gnu/libm.so;/opt/ros/noetic/lib/liboctomap.so.1.9.6;/opt/ros/noetic/lib/liboctomap.so;/opt/ros/noetic/lib/liboctomath.so;/usr/lib/x86_64-linux-gnu/liburdfdom_sensor.so;/usr/lib/x86_64-linux-gnu/liburdfdom_model_state.so;/usr/lib/x86_64-linux-gnu/liburdfdom_model.so;/usr/lib/x86_64-linux-gnu/liburdfdom_world.so;/usr/lib/x86_64-linux-gnu/libconsole_bridge.so.0.4;BulletSoftBody;BulletDynamics;BulletCollision;LinearMath")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT moveit_core_NUM_DUMMY_TARGETS)
      set(moveit_core_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::moveit_core::wrapped-linker-option${moveit_core_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR moveit_core_NUM_DUMMY_TARGETS "${moveit_core_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::moveit_core::wrapped-linker-option${moveit_core_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND moveit_core_LIBRARIES "${interface_target_name}")
