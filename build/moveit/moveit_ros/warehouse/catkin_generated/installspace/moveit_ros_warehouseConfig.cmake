...
if("FALSE" STREQUAL "TRUE")
  set(moveit_ros_warehouse_SOURCE_PREFIX /home/ros/abb_ws/src/moveit/moveit_ros/warehouse)
  set(moveit_ros_warehouse_DEVEL_PREFIX /home/ros/abb_ws/devel)
  ...
  set(moveit_ros_warehouse_INSTALL_PREFIX /home/ros/abb_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_ros_warehouse' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT moveit_ros_warehouse_NUM_DUMMY_TARGETS)
      set(moveit_ros_warehouse_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::moveit_ros_warehouse::wrapped-linker-option${moveit_ros_warehouse_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR moveit_ros_warehouse_NUM_DUMMY_TARGETS "${moveit_ros_warehouse_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::moveit_ros_warehouse::wrapped-linker-option${moveit_ros_warehouse_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND moveit_ros_warehouse_LIBRARIES "${interface_target_name}")
...
set(depends "moveit_ros_planning;warehouse_ros;roscpp")
