...
if("FALSE" STREQUAL "TRUE")
  set(moveit_ros_planning_interface_SOURCE_PREFIX /home/ros/abb_ws/src/moveit/moveit_ros/planning_interface)
  set(moveit_ros_planning_interface_DEVEL_PREFIX /home/ros/abb_ws/devel)
  ...
  set(moveit_ros_planning_interface_INSTALL_PREFIX /home/ros/abb_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'moveit_ros_planning_interface' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'moveit_ros_planning_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
    _list_append_unique(moveit_ros_planning_interface_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "moveit_common_planning_interface_objects;moveit_planning_scene_interface;moveit_move_group_interface;moveit_py_bindings_tools")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT moveit_ros_planning_interface_NUM_DUMMY_TARGETS)
      set(moveit_ros_planning_interface_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::moveit_ros_planning_interface::wrapped-linker-option${moveit_ros_planning_interface_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR moveit_ros_planning_interface_NUM_DUMMY_TARGETS "${moveit_ros_planning_interface_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::moveit_ros_planning_interface::wrapped-linker-option${moveit_ros_planning_interface_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND moveit_ros_planning_interface_LIBRARIES "${interface_target_name}")
...
set(depends "actionlib;geometry_msgs;moveit_msgs;moveit_ros_planning;moveit_ros_warehouse;moveit_ros_manipulation;moveit_ros_move_group;roscpp;tf2_geometry_msgs")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${moveit_ros_planning_interface_dep}_FOUND)
      find_package(${moveit_ros_planning_interface_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${moveit_ros_planning_interface_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _pack_libraries_with_build_configuration(moveit_ros_planning_interface_LIBRARIES ${moveit_ros_planning_interface_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${moveit_ros_planning_interface_dep}_LIBRARIES})
  _list_append_deduplicate(moveit_ros_planning_interface_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(moveit_ros_planning_interface_LIBRARIES ${moveit_ros_planning_interface_LIBRARIES})
