...
bool operator==(const ::industrial_msgs::CmdJointTrajectoryRequest_<ContainerAllocator1> & lhs, const ::industrial_msgs::CmdJointTrajectoryRequest_<ContainerAllocator2> & rhs)
{
...
struct Definition< ::industrial_msgs::CmdJointTrajectoryRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Send a JointTrajectory command to the robot.\n"
