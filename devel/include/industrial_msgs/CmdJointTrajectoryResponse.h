...
bool operator==(const ::industrial_msgs::CmdJointTrajectoryResponse_<ContainerAllocator1> & lhs, const ::industrial_msgs::CmdJointTrajectoryResponse_<ContainerAllocator2> & rhs)
{
