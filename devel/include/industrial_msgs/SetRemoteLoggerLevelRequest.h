...
bool operator==(const ::industrial_msgs::SetRemoteLoggerLevelRequest_<ContainerAllocator1> & lhs, const ::industrial_msgs::SetRemoteLoggerLevelRequest_<ContainerAllocator2> & rhs)
{
...
struct Definition< ::industrial_msgs::SetRemoteLoggerLevelRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Sets logging level for a remote device that is attached to\n"
